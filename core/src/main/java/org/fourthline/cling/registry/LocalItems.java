...
class LocalItems extends RegistryItems<LocalDevice, LocalGENASubscription> {
    ...
    Collection<LocalDevice> get() {
        Set<LocalDevice> c = new HashSet<LocalDevice>();
    ...
    void maintain() {
        ...
        Set<RegistryItem<UDN, LocalDevice>> expiredLocalItems = new HashSet<RegistryItem<UDN, LocalDevice>>();
        ...
        Set<RegistryItem<String, LocalGENASubscription>> expiredIncomingSubscriptions = new HashSet<RegistryItem<String, LocalGENASubscription>>();
