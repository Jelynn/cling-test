...
class RemoteItems extends RegistryItems<RemoteDevice, RemoteGENASubscription> {
    ...
    void maintain() {
        ...
        Map<UDN, RemoteDevice> expiredRemoteDevices = new HashMap<UDN, RemoteDevice>();
        ...
        Set<RemoteGENASubscription> expiredOutgoingSubscriptions = new HashSet<RemoteGENASubscription>();
    ...
    void shutdown() {
        ...
        List<RemoteGENASubscription> remoteSubscriptions = new ArrayList<RemoteGENASubscription>();
        for (RegistryItem<String, RemoteGENASubscription> item : getSubscriptionItems()) {
